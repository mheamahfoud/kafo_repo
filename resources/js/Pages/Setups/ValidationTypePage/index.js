...
import AddValidationType from '../../../components/dialogs/setup/validationTypes/AddValidationType';
import EditValidationType from '../../../components/dialogs/setup/validationTypes/EditValidationType';
...
import { ActivateDeactivateValidationType } from '../../../api/setUp/ValidationType';
...
export default function DataGridDemo() {
    ...
    const handleActivateDialogYes = () => {
        ActivateDeactivateValidationType({ 'id': dialog_confirm_data.id }).then(
            (res) => {
                if (res.success) {
    ...
    return (
        <React.Fragment>
            ...
            <Paper className={GeneralStyles.paperhearder} elevation={5}>
                <DataTable rows={rows} columns={columns} setAddDialogOpen={setAddDialogOpen} loading={loading} type={'validationTypes'}  />
