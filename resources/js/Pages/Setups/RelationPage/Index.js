...
import AddRelationDialog from '../../../components/dialogs/setup/relations/AddRelation';
import EditRelationDialog from '../../../components/dialogs/setup/relations/EditRelation';
import { GetRelations } from '../../../api/setUp/relation';
...
import { ActivateDeactivateRelation } from '../../../api/setUp/relation';
...
export default function RelationPage() {
    ...
    const handleActivateDialogYes = () => {
        ActivateDeactivateRelation({ 'id': dialog_confirm_data.id }).then(
            (res) => {
                if (res.success) {
    ...
    return (
        <React.Fragment>
            ...
            <Paper className={GeneralStyles.paperhearder} elevation={5}>
                ...
                <DataTable rows={rows} columns={columns} setAddDialogOpen={setAddDialogOpen} loading={loading} type={'relations'} />
