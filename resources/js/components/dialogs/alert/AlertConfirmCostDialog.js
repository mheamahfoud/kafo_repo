...
import { globalSelector,setDialogConfirmCostOpen } from '../../../redux/features/global_slice';
...
export default function AlertConfirmCostDialog({ dialog_open, message, callBack, title }) {
    const dispatch = useDispatch()
    const { t } = useTranslation();
    const {dialog_confirm_cost_open} = useSelector(globalSelector)
    const handleClose = () => {
