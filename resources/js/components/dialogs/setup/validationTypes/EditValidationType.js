...
import ValidationTypeForm from './ValidationTypeForm';
import { UpdateValidationType, } from '../../../../api/setUp/ValidationType';
...
export default function EditValidationType({ open, ...props }) {
    const { t } = useTranslation();
    const { enqueueSnackbar } = useSnackbar();
    const [loading, setLoading] = React.useState(false);
    const classes = useStyles();
    const ValidationTypeSchema = Yup.object().shape({
        ...
        >
            ...
            <Formik
                ...
                onSubmit={async (values) => {
                    ...
                    setLoading(true)
                    UpdateValidationType(props.data.id, values).then((result) => {
                        if (result.success) {
