...
import { CreateValidationType, } from '../../../../api/setUp/ValidationType';
...
export default function AddValidationType({ open, ...props }) {
        ...
        >
            ...
            <Formik
                ...
                onSubmit={async (values) => {
                    setLoading(true)
                    CreateValidationType(values).then((result) => {
