...
export default function FormikCheckBoxGroupCardStyle({
    isRequired,
    setFieldValue,
    name,
    options,
            ...
            _.groupBy(
                options.map((option) => {
                    return {
                        ...
                        position_name:
                            option.positions[0].name,
                    };
                }),
                function (option) {
                    return option.positions[0].name;
                },
            ),
        );
    }, [options, values[name]]);
    ...
    let checkerSome = (arr, target) => target.every((v) => arr.includes(v)) ? false : target.some((v) => arr.includes(v));
                        ...
                        <FormControlLabel
                            ...
                            control={
                                <Checkbox
                                    ...
                                    indeterminate={values[name] && values[name].split(',').length > 0 && values[name].split(',').length < options.length
                                    }
                                            ...
                                            <Box display="flex">
                                                ...
                                                <Box padding='5px'>
                                                    <Checkbox
                                                        ...
                                                        indeterminate={values[name] && checkerSome(
                                                            values[name]
                                                                .split(',')
                                                                .map(
                                                                    Number,
